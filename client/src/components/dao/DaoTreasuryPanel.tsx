...
export default function DaoTreasuryPanel({
  data,
}: {
  ...
  return (
    <div>
      ...
      <p className="muted-line mt-2">
        Large allocations show policy warnings in proposals. Long narratives
        stay off-chain; Solana holds compact proof.
      </p>
    </div>
  );
}
