...
export function SolanaSessionBanner({
    ...
    return (
      ...
      >
        ...
        <p className="text-amber-100/85">
          Switch your wallet RPC to match this command center, then refresh the
          verified session.
        </p>
      </div>
    );
    ...
    return (
      ...
      >
        ...
        <p className="text-cyan-100/85">
          Sign the human-readable verification message to authorize publishing,
          execution, and receipt anchoring for this wallet.
        </p>
        {message ? (
          <p className="mt-2 whitespace-pre-wrap rounded-lg bg-black/30 p-3 font-mono text-xs">
            {message}
          </p>
        ) : null}
      </div>
  ...
  return (
    ...
    >
      ...
      <p className="text-[#d5ffe9]/90">
        Backend attestation active — receipts and registry writes can use your
        wallet authority.
      </p>
    </div>
  );
