      ...
      {open ? (
        <div className="space-y-2 border-t border-white/10 pt-3 text-xs">
          ...
          <p className="text-slate-600">
            Anyone can verify this receipt on Solana against the published
            hashes.
          </p>
          <ExplorerLinkButton
            payload={{
              label: "Verify on Solana Explorer",
