...
export const SOLANA_CLUSTER = (env.VITE_SOLANA_CLUSTER ||
...
export const SOLANA_EXPLORER_BASE =
  env.VITE_SOLANA_EXPLORER_BASE || "https://explorer.solana.com";
...
export const DEMO_MODE =
  import.meta.env.VITE_CLAW_DEMO_MODE === "1" ||
  import.meta.env.VITE_CLAW_DEMO_MODE === "true";
